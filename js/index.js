$(function() {
	...
	c.load("<div class='bef_comment writecode'>&nbsp;*hi,我的名字叫周师伟</div>");
	c.load("<div class='bef_comment writecode'>&nbsp;*是一名php程序员</div>",2000);
	c.load("<div class='bef_comment writecode'>&nbsp;*让我们来点实际的，看看我能做些什么。Ps：配置服务器太贵，我等穷屌丝只能选择用github来展示静态页面了。</div>");
	...
	w.load("<p><div class='writecode'>周师伟</div>");
	w.load("<div class='writecode'>湖北衣谷电子商务有限公司</div>");
	w.load("<div class='writecode'>PHP程序员</div></p>");
	w.load("<h1 class='writecode'>联系我</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'>mail:381892656@qq.com</li>");
	w.load("<li class='writecode'>blog:<a href='http://blog.csdn.net/zhou120189162' target='_blank'>http://blog.csdn.net/zhou120189162</a></li>");
	w.load("<li class='writecode'>github:<a href='https://github.com/zhou381892656' target='_blank'>https://github.com/zhou381892656</a></li>");
	w.load("</ul>");
	w.load("<h1 class='writecode'>技能</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'>精通php，熟悉主流框架</li>");
	w.load("<li class='writecode'>熟练掌握js</li>");
	w.load("<li class='writecode'>熟练各种Web前端开发技术H5,CSS3,jQuery</li>");
	w.load("<li class='writecode'>熟练与各平台和硬件的技术对接（如: 微信接口，三方支付，系统整合）</li>");
	w.load("<li class='writecode'>熟练掌握Mysql</li>");
	w.load("<li class='writecode'>熟悉windows server,linux服务器部署和管理，及常见问题的处理</li>");
	w.load("<li class='writecode'>熟悉svn,git等常用版本管理工具</li>");
	w.load("</ul>");
	w.load("<h1 class='writecode'>项目</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'><a href='http://www.egu123.com' target='_blank'>http://www.egu123.com</a></li>");
	w.load("<li class='writecode'><a href='http://www.injoyard.com' target='_blank'>http://www.injoyard.com</a></li>");
	w.load("<li class='writecode'><a href='http://www.58xgh.com' target='_blank'>http://www.58xgh.com</a></li>");
	w.load("<li class='writecode'><a href='http://www.hbhclib.com/' target='_blank'>http://www.hbhclib.com/</a></li>");
	w.load("<li class='writecode'><a href='http://yun.egu123.com/' target='_blank'>http://yun.egu123.com/</a></li>");
	w.load("</ul>");
	c.load("<p><div class='comment writecode'>/**</div>");
	...
	c.load("<div class='comment writecode'>&nbsp;*QQ/微信:381892656/Azreal_zhou</div>");
	c.load("<div class='comment writecode'>&nbsp;*mobile:15272799627</div>");
